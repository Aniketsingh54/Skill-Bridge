...
**Roadmap Generation (Strategy Pattern)**
...
```mermaid
graph TB
    classDef browser fill:#1e3a5f,stroke:#4a9eff,color:#e0f0ff,rx:8
    classDef api fill:#1a3a2a,stroke:#4caf82,color:#d0ffe8,rx:8
    classDef ingestion fill:#2a2a1a,stroke:#c8a84b,color:#fff8da,rx:8
    classDef generation fill:#2a1a2a,stroke:#b87fcb,color:#f5e0ff,rx:8
    classDef external fill:#2a1a1a,stroke:#e05c5c,color:#ffe0e0,rx:8
    ...
    class UI,Graph,EmailBuilder browser
    class Analyze,SendEmail,SampleData api
    class Base,RawText,PDF ingestion
    class Strategy,AI,DAG generation
